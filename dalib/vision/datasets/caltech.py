...
class Caltech256(ImageList):
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        data_list_file = os.path.join(root, "image_list/256_ObjectCategories.txt")
        ...
        super(Caltech256, self).__init__(root, Caltech256.CLASSES, data_list_file=data_list_file, **kwargs)
