...
class CaltechImageNet(ImageList):
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = True, **kwargs):
        ...
        super(CaltechImageNet, self).__init__(root, CLASSES, data_list_file=data_list_file, **kwargs)
...
class CaltechImageNetUniversal(ImageList):
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = True, **kwargs):
        ...
        super(CaltechImageNetUniversal, self).__init__(root, CLASSES + ['unknown'],
