...
sys.path.append('../..')
from ftlib.modules.classifier import Classifier
...
from ftlib.finetune.BSS import BSS
...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        # train for one epoch
        train(train_iter, classifier, bss_module, optimizer,
...
def train(train_iter: ForeverDataIterator, model: Classifier, bss_module: BSS, optimizer: SGD,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--t', default=0.001, type=float,
                        metavar='P', help='weight of BSS loss')
