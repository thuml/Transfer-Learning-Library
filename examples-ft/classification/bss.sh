...
# Standford Cars
CUDA_VISIBLE_DEVICES=0 python bss.py data/stanford_cars --lr-decay-epochs 12 20 -d StanfordCars -sr 100 --seed 0 --log logs/bss/car_100
CUDA_VISIBLE_DEVICES=0 python bss.py data/stanford_cars --lr-decay-epochs 12 20 -d StanfordCars -sr 50 --seed 0 --log logs/bss/car_50
CUDA_VISIBLE_DEVICES=0 python bss.py data/stanford_cars --lr-decay-epochs 12 20 -d StanfordCars -sr 30 --seed 0 --log logs/bss/car_30
CUDA_VISIBLE_DEVICES=0 python bss.py data/stanford_cars --lr-decay-epochs 12 20 -d StanfordCars -sr 15 --seed 0 --log logs/bss/car_15
