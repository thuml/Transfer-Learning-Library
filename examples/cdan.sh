#!/usr/bin/env bash
# Office31
python examples/cdan.py data/office31 -d Office31 -s A -t W -a resnet50 --gpu 0 --epochs 20  > benchmarks/cdan/Office31_A2W.txt
python examples/cdan.py data/office31 -d Office31 -s D -t W -a resnet50 --gpu 0 --epochs 20  > benchmarks/cdan/Office31_D2W.txt
python examples/cdan.py data/office31 -d Office31 -s W -t D -a resnet50 --gpu 0 --epochs 20  > benchmarks/cdan/Office31_W2D.txt
python examples/cdan.py data/office31 -d Office31 -s A -t D -a resnet50 --gpu 0 --epochs 20  > benchmarks/cdan/Office31_A2D.txt
python examples/cdan.py data/office31 -d Office31 -s D -t A -a resnet50 --gpu 0 --epochs 20  > benchmarks/cdan/Office31_D2A.txt
