...
CUDA_VISIBLE_DEVICES=0 python adda.py data/wilds -d iwildcam -a resnet50 --epochs 30 -i 1000 --seed 0 --log logs/adda/iwildcam

# DenseNet121, Wilds Dataset
CUDA_VISIBLE_DEVICES=0 python adda.py data/wilds -d camelyon17 --train-resizing 'res.' --val-resizing 'res.' --resize-size 96 \
  -a densenet121 --scratch --epochs 10 -i 1000 --lr 0.01 --seed 0 --log logs/adda/camelyon17
CUDA_VISIBLE_DEVICES=0 python adda.py data/wilds -d fmow --train-resizing 'res.' --val-resizing 'res.' \
  -a densenet121 --epochs 10 -i 1000 --lr 0.01 --seed 0 --log logs/adda/fmow
...
CUDA_VISIBLE_DEVICES=0 python adda.py data/digits -d Digits -s SVHNRGB -t MNISTRGB --train-resizing 'res.' --val-resizing 'res.' \
  --resize-size 32 --no-hflip --norm-mean 0.5 0.5 0.5 --norm-std 0.5 0.5 0.5 -a dtn --no-pool --lr 0.1 -b 128 -i 2500 --scratch --seed 0 --log logs/adda/SVHN2MNIST
