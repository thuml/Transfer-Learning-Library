...
CUDA_VISIBLE_DEVICES=0 python source_only.py data/surreal data/surreal \
    -s SURREAL -t SURREAL



CUDA_VISIBLE_DEVICES=3 python source_only.py data/Human36M data/Human36M \
    -s Human36M -t Human36M --log logs/baseline/surreal2human36m --debug --seed 0 --rotation 30