...
CUDA_VISIBLE_DEVICES=3 python source_only.py \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/voc2clipart
...
CUDA_VISIBLE_DEVICES=5 python source_only.py \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/voc2watercolor_comic MODEL.ROI_HEADS.NUM_CLASSES 6
...
CUDA_VISIBLE_DEVICES=4 python source_only.py \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/cityscapes2foggy
...
CUDA_VISIBLE_DEVICES=5 python source_only.py \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/sim10k2cityscapes_car MODEL.ROI_HEADS.NUM_CLASSES 1
...
CUDA_VISIBLE_DEVICES=4 python source_only.py \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/gta52cityscapes
