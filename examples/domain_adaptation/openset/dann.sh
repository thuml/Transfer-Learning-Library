#!/usr/bin/env bash
# Office31
CUDA_VISIBLE_DEVICES=5 python dann.py data/office31 -d Office31 -s A -t W -a resnet50 --epochs 20 --seed 0 --threshold 0.9 --log logs/dann/Office31_A2W
...
CUDA_VISIBLE_DEVICES=0 python dann.py data/visda-2017 -d VisDA2017 -s Synthetic -t Real -a resnet50 \
    --epochs 30 --seed 0 --center-crop --per-class-eval --log logs/dann/VisDA2017_S2R
