...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        # train for one epoch
        train(train_source_iter, train_target_iter, classifier, mdd, class_weight_module, optimizer,
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          classifier: ImageClassifier, mdd: MarginDisparityDiscrepancy,
          class_weight_module: AutomaticUpdateClassWeightModule, optimizer: SGD,
    ...
    progress = ProgressMeter(
        ...
        [batch_time, data_time, losses, trans_losses, cls_accs, tgt_accs, partial_classes_weights,
         non_partial_classes_weights],
    ...
    for i in range(args.iters_per_epoch):
        ...
        transfer_loss = -mdd(y_s, y_s_adv, y_t, y_t_adv, w_s, w_t)
