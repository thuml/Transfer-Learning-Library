...
CUDA_VISIBLE_DEVICES=0 python source_only.py data/visda-2017 -d VisDA2017 -s Synthetic -t Real -a resnet50 \
    --epochs 10 -i 500 --seed 0 --per-class-eval --log logs/src_only/VisDA2017_S2R

# ImageNet-Caltech
CUDA_VISIBLE_DEVICES=0 python source_only.py data/ImageNetCaltech -d ImageNetCaltech -s I -t C -a resnet50 \
    --epochs 20 --seed 0 -i 2000 --log logs/src_only/I2C
CUDA_VISIBLE_DEVICES=0 python source_only.py data/ImageNetCaltech -d CaltechImageNet -s C -t I -a resnet50 \
    --epochs 20 --seed 0 -i 2000 --log logs/src_only/C2I
