...
CUDA_VISIBLE_DEVICES=0,1,2,3 python baseline_cluster.py data -t DukeMTMC -a reid_resnet50 \
...
# step2: train with pseudo labels assigned by cluster algorithm
CUDA_VISIBLE_DEVICES=0,1,2,3 python baseline_cluster.py data -t Market1501 -a reid_resnet50 \
...
# step2: train with pseudo labels assigned by cluster algorithm
CUDA_VISIBLE_DEVICES=0,1,2,3 python baseline_cluster.py data -t MSMT17 -a reid_resnet50 \
