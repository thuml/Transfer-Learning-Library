...
def main(args: argparse.Namespace):
    ...
    optimizer = SGD(classifier.parameters(), 1, momentum=args.momentum, weight_decay=args.wd, nesterov=True)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          classifier, mkmmd_loss: MultipleKernelMaximumMeanDiscrepancy, optimizer: SGD,
