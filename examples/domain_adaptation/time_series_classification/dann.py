...
def main(args: argparse.Namespace):
    ...
    domain_discri = DomainDiscriminator(in_feature=classifier.features_dim, hidden_size=512).to(device)

    # define optimizer and lr scheduler
    optimizer = SGD(chain(classifier.parameters(), domain_discri.parameters()), 1, momentum=args.momentum, weight_decay=args.weight_decay, nesterov=True)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          classifier, domain_adv: DomainAdversarialLoss, optimizer: SGD,
    ...
    progress = ProgressMeter(
        ...
        [batch_time, data_time, losses, trans_losses, cls_accs, tgt_accs, domain_accs],
