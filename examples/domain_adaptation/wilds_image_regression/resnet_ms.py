...
def resnet18_ms(num_classes=10, num_channels=3):
    model = ResNetMS(num_channels, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    return model


def resnet34_ms(num_classes=10, num_channels=3):
    model = ResNetMS(num_channels, BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
    return model


def resnet50_ms(num_classes=10, num_channels=3):
    model = ResNetMS(num_channels, Bottleneck, [3, 4, 6, 3], num_classes=num_classes)
    return model


def resnet101_ms(num_classes=10, num_channels=3):
    model = ResNetMS(num_channels, Bottleneck, [3, 4, 23, 3], num_classes=num_classes)
    return model


def resnet152_ms(num_classes=10, num_channels=3):
    model = ResNetMS(num_channels, Bottleneck, [3, 8, 36, 3], num_classes=num_classes)
    return model
