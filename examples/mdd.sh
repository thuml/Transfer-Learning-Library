...
# VisDA-2017
python examples/mdd.py data/visda-2017 -d VisDA2017 -s T -t V -a resnet50  --epochs 30 --bottleneck_dim 1024 --seed 0 --center_crop > benchmarks/mdd/VisDA2017_2.txt
python examples/mdd.py data/visda-2017 -d VisDA2017 -s T -t V -a resnet101  --epochs 30 --bottleneck_dim 1024 --seed 0 --center_crop > benchmarks/mdd/VisDA2017_resnet101_3.txt
