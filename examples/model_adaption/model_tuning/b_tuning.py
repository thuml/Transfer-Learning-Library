...
sys.path.append('../../..')
from tllib.ranking import PosteriorPredictiveAlignment
...
def main(args: argparse.Namespace):
    ...
    alignment_module = PosteriorPredictiveAlignment(args.result_path, args.arch, args.teachers, args.temperature, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--result-path', help='path to outputs of LogME')
