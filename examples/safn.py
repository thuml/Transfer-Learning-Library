...
def main(args):
    ...
    for epoch in range(args.epochs):
        # train for one epoch
        train(train_source_iter, train_target_iter, classifier, safn, optimizer, epoch, args)
...
def train(train_source_iter, train_target_iter, model, safn, optimizer, epoch, args):
