...
CUDA_VISIBLE_DEVICES=0 python erm.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  ...
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/cifar100_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  --norm-mean 0.5071 0.4867 0.4408 --norm-std 0.2675 0.2565 0.2761 --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/cifar100_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
...
CUDA_VISIBLE_DEVICES=0 python erm.py data/cub200 -d CUB200 --num-sample-per-class 10 --finetune \
  ...
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/cub200 -d CUB200 --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/cub200_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth

# ======================================================================================================================
# Aircraft
CUDA_VISIBLE_DEVICES=0 python erm.py data/aircraft -d Aircraft --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/aircraft_4_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/aircraft -d Aircraft --num-samples-per-class 10 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/aircraft_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/aircraft -d Aircraft --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/aircraft_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
...
CUDA_VISIBLE_DEVICES=0 python erm.py data/cars -d StanfordCars --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/car_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
...
CUDA_VISIBLE_DEVICES=0 python erm.py data/sun397 -d SUN397 --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/sun_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth

# ======================================================================================================================
# DTD
CUDA_VISIBLE_DEVICES=0 python erm.py data/dtd -d DTD --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/dtd_4_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/dtd -d DTD --num-samples-per-class 10 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/dtd_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/dtd -d DTD --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/dtd_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth

# ======================================================================================================================
# Oxford Pets
CUDA_VISIBLE_DEVICES=0 python erm.py data/pets -d OxfordIIITPets --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/pets_4_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/pets -d OxfordIIITPets --num-samples-per-class 10 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/pets_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/pets -d OxfordIIITPets --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/pets_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth

# ======================================================================================================================
# Oxford Flowers
CUDA_VISIBLE_DEVICES=0 python erm.py data/flowers -d OxfordFlowers102 --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/flowers_4_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/flowers -d OxfordFlowers102 --num-samples-per-class 10 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/flowers_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/flowers -d OxfordFlowers102 --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/flowers_oracle --lr-scheduler cos --epochs 40 -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth

# ======================================================================================================================
# Caltech 101
CUDA_VISIBLE_DEVICES=0 python erm.py data/caltech101 -d Caltech101 --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/caltech_4_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/caltech101 -d Caltech101 --num-samples-per-class 10 --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/caltech_10_labels_per_class --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
CUDA_VISIBLE_DEVICES=0 python erm.py data/caltech101 -d Caltech101 --oracle --finetune \
  -a resnet50 --seed 0 --log logs/erm_moco_pretrain/caltech_oracle --lr-scheduler cos -i 2000 \
  --pretrained-backbone checkpoints/moco_v2_800ep_backbone.pth
