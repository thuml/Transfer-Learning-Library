...
# ======================================================================================================================
# Food 101
CUDA_VISIBLE_DEVICES=0 python self_tuning.py data/food101 -d Food101 --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/self_tuning/food101_4_labels_per_class
...
CUDA_VISIBLE_DEVICES=0 python self_tuning.py data/cifar10 -d CIFAR10 --train-resizing 'cifar' --val-resizing 'cifar' \
  ...
  -a resnet50 --seed 0 --log logs/self_tuning/cifar10_4_labels_per_class
...
CUDA_VISIBLE_DEVICES=0 python self_tuning.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  ...
  -a resnet50 --seed 0 --log logs/self_tuning/cifar100_4_labels_per_class
...
# ======================================================================================================================
# DTD
CUDA_VISIBLE_DEVICES=0 python self_tuning.py data/dtd -d DTD --num-samples-per-class 4 --finetune \
  -a resnet50 --seed 0 --log logs/self_tuning/dtd_4_labels_per_class
