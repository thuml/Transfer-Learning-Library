...
# Resisc45
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/resisc45 -d Resisc45 -sc 10 --finetune --seed 0 \
  --log logs/co_tuning/resisc45_10
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/resisc45 -d Resisc45 -sc 20 --finetune --seed 0 \
  --log logs/co_tuning/resisc45_20
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/resisc45 -d Resisc45 -sc 40 --finetune --seed 0 \
  --log logs/co_tuning/resisc45_40
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/resisc45 -d Resisc45 -sc 80 --finetune --seed 0 \
  --log logs/co_tuning/resisc45_80

# Patch Camelyon
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/patch_camelyon -d PatchCamelyon -sc 40 --finetune \
  --seed 0 --log logs/co_tuning/patch_camelyon_40
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/patch_camelyon -d PatchCamelyon -sc 80 --finetune \
  --seed 0 --log logs/co_tuning/patch_camelyon_80
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/patch_camelyon -d PatchCamelyon -sc 160 --finetune \
  --seed 0 --log logs/co_tuning/patch_camelyon_160
CUDA_VISIBLE_DEVICES=0 python co_tuning.py data/vtab/patch_camelyon -d PatchCamelyon -sc 320 --finetune \
  --seed 0 --log logs/co_tuning/patch_camelyon_320
