...
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/cifar10 --dataset CIFAR10 --num-samples-per-class 4 \
  ...
  --opt-level O0 --log logs/fixmatch/cifar10_40_labels
# ======================================================================================================================
...
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/svhn --dataset SVHN --num-samples-per-class 4 \
  ...
  --arch WideResNet --depth 28 --widen-factor 2 --lr 0.03 -b 64 -ub 448 --threshold 0.95 --weight-decay 0.0005 \
  --opt-level O0 --log logs/fixmatch/svhn_40_labels
# ======================================================================================================================
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port 16667 fixmatch.py \
  ...
  --img-size 96 96 --norm-mean 0.441 0.428 0.387 --norm-std 0.268 0.261 0.269 \
  --arch WideResNetVar --depth 28 --widen-factor 2 --sync-bn --lr 0.03 -b 32 -ub 224 --threshold 0.95 --weight-decay 0.0005 \
  --opt-level O0 --log logs/fixmatch/stl10_40_labels
# ======================================================================================================================
