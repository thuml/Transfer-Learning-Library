...
# Acc@1
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/cifar10 --dataset CIFAR10 --num-samples-per-class 4 \
  ...
  --opt-level O0 --deterministic --log logs/fixmatch/cifar10_40_labels
# ======================================================================================================================
...
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/cifar100 --dataset CIFAR100 --num-samples-per-class 4 \
  ...
  --opt-level O0 --deterministic --log logs/fixmatch/cifar100_400_labels
...
# Acc@1
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/svhn --dataset SVHN --num-samples-per-class 4 \
  --norm-mean 0.438 0.444 0.473 --norm-std 0.175 0.177 0.174 \
  --arch WideResNet --depth 28 --widen-factor 2 --lr 0.03 -b 64 -ub 448 --threshold 0.95 --weight-decay 0.0005 \
  --opt-level O0 --deterministic --log logs/fixmatch/svhn_40_labels
# ======================================================================================================================
...
CUDA_VISIBLE_DEVICES=0 python fixmatch.py --root data/stl10 --dataset STL10 --num-samples-per-class 4 \
  ...
  --opt-level O0 --deterministic --log logs/fixmatch/stl10_40_labels
# ======================================================================================================================
