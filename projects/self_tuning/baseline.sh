...
CUDA_VISIBLE_DEVICES=0 python baseline.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  --norm-mean 0.5071 0.4867 0.4408 --norm-std 0.2675 0.2565 0.2761 \
  -a efficientnet_b2 -b 40 --num-samples 400 --seed 0 --log logs/baseline/cifar100_400

CUDA_VISIBLE_DEVICES=0 python baseline.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  --norm-mean 0.5071 0.4867 0.4408 --norm-std 0.2675 0.2565 0.2761 \
  -a efficientnet_b2 -b 40 --num-samples 2500 --seed 0 --log logs/baseline/cifar100_2500

CUDA_VISIBLE_DEVICES=0 python baseline.py data/cifar100 -d CIFAR100 --train-resizing 'cifar' --val-resizing 'cifar' \
  --norm-mean 0.5071 0.4867 0.4408 --norm-std 0.2675 0.2565 0.2761 \
  -a efficientnet_b2 -b 40 --num-samples 10000 --seed 0 --log logs/baseline/cifar100_10000
