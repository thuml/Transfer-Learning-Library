...
from common.vision.datasets._util import download as download_data, check_exits
...
class StanfordCars(ImageList):
    ...
    """
    download_list = [
        ("image_list", "image_list.zip", "https://cloud.tsinghua.edu.cn/f/87cf8f74b8cb445db0a3/?dl=1"),
    ...
    image_list = {
        ...
        "train50_unlabeled": "image_list/train_50_unlabeled.txt",
        "train30_unlabeled": "image_list/train_30_unlabeled.txt",
        "train15_unlabeled": "image_list/train_15_unlabeled.txt",
    }
    ...
    def __init__(self, root: str, split: str, sample_rate: Optional[int] = 100, download: Optional[bool] = False,
                 unlabeled: Optional[bool] = False, **kwargs):

        if split == 'train':
            list_name = 'train' + str(sample_rate)
            if unlabeled:
                list_name = 'train' + str(sample_rate) + '_unlabeled'
