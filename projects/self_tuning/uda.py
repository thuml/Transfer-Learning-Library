...
def main(args: argparse.Namespace):
    ...
    unlabel_train_transform = MultipleApply([T.Compose(weak_augmentation), T.Compose(strong_augmentation)])
    ...
    unlabeled_train_dataset = dataset(root=args.root, split='train', sample_rate=args.sample_rate,
                                      download=True, transform=unlabel_train_transform, unlabeled=True)
